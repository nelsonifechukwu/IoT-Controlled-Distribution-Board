...
from app.models import checklogin, delete_dist_data, insert_distribution_data, get_distribution_data, get_dist_state, update_dist_state, insert_dist_state, delete_dist_state
import json
import random
